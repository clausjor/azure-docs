...
|Target request rate for a single blob | Up to 500 |
|Target throughput for a single page blob |Up to 60 MiB per seconds |
|Target throughput for single block blob |Up to storage account ingress/egress limits<sup>1</sup> |
